...
import InkBar from './VerticalInkBar';
...
class Tabs extends Component {
  ...
  render() {
    ...
    const tabContent = [];
    const height = 100 / this.getTabCount();
    ...
    const inkBarContainerheight = tabItemContainerStyle ?
      tabItemContainerStyle.height : styles.tabItemContainer.height;
    ...
    return (
      <div
        {...other}
        style={prepareStyles(Object.assign({}, defaultContainerStyle, style))}
      >
        <div
        ...
        <div style={{height: inkBarContainerheight}}>
          {inkBar}
        </div>
