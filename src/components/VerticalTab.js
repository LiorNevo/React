  ...
  render() {
    ...
    if (icon && React.isValidElement(icon)) {
      ...
      if (icon.type.muiName !== 'FontIcon') {
        iconProps.color = '#a4a4a4';
      }
      if (selected){
        iconProps.color = '#0194d5';
      }
    ...
    if (selected){
      defaultStyle.color = '#0194d5';
      defaultStyle.backgroundColor = 'rgba(255, 255, 255, 0)';
    }
    return (
      <EnhancedButton
        {...other}
        style={Object.assign(styles.root, defaultStyle, style)}
